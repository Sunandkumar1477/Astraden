                ...
                <div class="dropdown-body">
                    ...
                    <a href="shop.php" class="menu-item">
                        ...
                        <div class="item-info">
                            ...
                            <div class="item-value">Claim Astrons</div>
                        </div>
                    </a>
                    <!-- Profile Link -->
    ...
    <div class="container">
        ...
        <div class="mobile-assist-container">
            ...
            <div class="mobile-categories-dropdown" id="mobileCategoriesDropdown">
                ...
                <a href="shop.php" class="mobile-category-option" style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.2), rgba(255, 165, 0, 0.2)); border-color: #FFD700; color: #FFD700; text-decoration: none; display: block;">🛒 Shop</a>
            </div>
        </div>
